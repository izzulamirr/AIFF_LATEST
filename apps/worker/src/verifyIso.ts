...
import { extractedTags, findings, documents, type createDb } from "@easy/db";
import {
  normalizeTagNumber,
  decodeLineNumber,
  enrichIsoLineAttrs,
...
export async function verifyIsoBom(db: Db, input: VerifyIsoBomInput): Promise<{ findingsCreated: number }> {
